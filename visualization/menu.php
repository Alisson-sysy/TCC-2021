  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
      <div class="navbar-nav">
        <a class="nav-link active" aria-current="page" href="/TCC/visualization/index.php">Home</a>
        <a class="nav-link" href="/TCC/visualization/front_list.php">Professores</a>
        ...
        <a class="nav-link" href="/TCC/settings/exit.php">Sair</a>
      </div>
    </div>
  </div>
</nav>